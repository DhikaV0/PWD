                        ...
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            @if ($errors->any())
                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                    <strong class="font-bold">Error!</strong> <span class="block sm:inline">{{ $errors->first() }}</span>
                                </div>
                            @endif
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="relative mb-6">
                                    <button type="submit" class="bg-cyan-500 text-white rounded-md px-2 py-1 w-96">Submit</button>
                                </div>
                                <div class="relative text-center pt-4">
                                    <span class="text-gray-600">Already have an account? </span>
                                    <a href="{{ route('login') }}" class="text-cyan-500 font-semibold hover:underline">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
